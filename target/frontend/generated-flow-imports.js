...
import $css_0 from 'Frontend/styles/home.css';
...
import $css_5 from 'Frontend/styles/commands.css';
addCssBlock(`<custom-style><style>${$css_5}</style></custom-style>`);
import $css_6 from 'Frontend/styles/dashboard.css';
addCssBlock(`<custom-style><style>${$css_6}</style></custom-style>`);
import $css_7 from 'Frontend/styles/featurerequests.css';
addCssBlock(`<custom-style><style>${$css_7}</style></custom-style>`);
import $css_8 from 'Frontend/styles/charts.css';
addCssBlock(`<dom-module id="flow_css_mod_8" theme-for="vaadin-chart"><template><style include="vaadin-chart-default-theme">${$css_8}</style></template></dom-module>`);
...
import '@vaadin/flow-frontend/custom-media-query.js';
