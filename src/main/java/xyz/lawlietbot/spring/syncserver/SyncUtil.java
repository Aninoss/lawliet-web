...
public class SyncUtil {
    ...
    public static CompletableFuture<Void> sendStripe(long userId, String title, String desc, int subId,
                                                     boolean unlocksServer, JSONArray presetGuilds) {
        ...
        json.put("preset_guilds", presetGuilds);
