...
public class ConfirmationDialog extends Div {
    ...
    public ConfirmationDialog(String text, ConfirmationDialogConfirmListener confirmListener, ConfirmationDialogCancelListener cancelListener) {
        this(text, confirmListener);
        this.cancelListener = cancelListener;
    }

    public ConfirmationDialog(String text, ConfirmationDialogConfirmListener confirmListener) {
