...
import $cssFromFile_1 from 'Frontend/styles/charts.css?inline';
import $cssFromFile_2 from 'Frontend/styles/styles.css?inline';
import $cssFromFile_3 from 'Frontend/styles/styles-reversed.css?inline';
import $cssFromFile_4 from 'Frontend/styles/bootstrap.css?inline';
import $cssFromFile_5 from 'Frontend/styles/main.css?inline';
import $cssFromFile_6 from 'Frontend/styles/commands.css?inline';
import $cssFromFile_7 from 'Frontend/styles/dashboard.css?inline';
import $cssFromFile_8 from 'Frontend/styles/featurerequests.css?inline';
import $cssFromFile_9 from 'Frontend/styles/gift.css?inline';
import $cssFromFile_10 from 'Frontend/styles/home.css?inline';
import $cssFromFile_11 from 'Frontend/styles/premium.css?inline';
import $cssFromFile_12 from 'Frontend/styles/htmldocument.css?inline';
...
import 'Frontend/generated/jar-resources/com/github/appreciated/grid-layout/grid-layout.js';
import 'Frontend/generated/jar-resources/client-media-query.ts';
import 'Frontend/generated/jar-resources/lit-media-query.ts';
import 'Frontend/generated/jar-resources/element-media-query.js';

injectGlobalCss($cssFromFile_0.toString(), 'CSSImport end', document);
const $css_1 = typeof $cssFromFile_1  === 'string' ? unsafeCSS($cssFromFile_1) : $cssFromFile_1;
registerStyles('vaadin-chart', $css_1, {include: 'vaadin-chart-default-theme', moduleId: 'flow_css_mod_1'});
